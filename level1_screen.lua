...
local function PositionAnswers()
    ...
    if (randomPosition == 1) then
        ...
        --alternateAnswerBox1
        alternateAnswerBox1.y = display.contentHeight * 0.25
...
local function TouchListenerAnswerBox3(touch)
    ...
    if (answerboxAlreadyTouched == false) and 
        ...
        elseif (touch.phase == "ended") then
            ...
            --else make box go back to where it was3PreviousX
                alternateAnswerBox3.y = alternateAnswerBox
            else
                alternateAnswerBox3.x = alternateAnswerBox3PreviousY
            end
        end
    end
end 
